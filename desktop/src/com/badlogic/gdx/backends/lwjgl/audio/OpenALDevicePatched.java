...
/** @author Nathan Sweet */
public class OpenALDevicePatched implements AudioDevice {
	...
	public OpenALDevicePatched (OpenALAudio audio, int sampleRate, boolean isMono, int bufferSize, int bufferCount) {
		this.audio = audio;
		channels = isMono ? 1 : 2;
